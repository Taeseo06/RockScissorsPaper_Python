...
#     button_end = tkinter.Button(tk, text="종료버튼.", font=("System", 15), command=tk.destroy)
...
# def option():  # 옵션함수
#     Destory_menu()
#     label_inpo = tkinter.Label(tk, text="터미널 (콘솔창)을 확인해주세요!!", font=("System", 45))
#     label_inpo.pack()

#     print("\n이 게임은 통상적인 가위,바위,보 게임으로 룰은 동일합니다.\n사용자가 가위, 바위, 보 중에서 하나를 택하여 선택버튼을 누르면 한라운드에서 유저의 손이 정해집니다.\n그럼 자동으로 컴의 값이 할당되고, 이를 비교하여 승, 패를 결정합니다.\n\n유저는 이러한 방식으로 게임을 진해해나갈 수 있으며, 좌측하단에 종료하기 버튼을 통해 프로그램을 종료시킬 수 있습니다.\n\n")

    
# def Destory_menu():  # 초기 메뉴티킨터 요소 삭제함수
#     label_menu.destroy()
...
#     im_rock = tkinter.PhotoImage(file="Rock_u.png")
...
#     Destory_hand()
#     cavas_hand.place(x=850, y=0)
#     im_scissors = tkinter.PhotoImage(file="Scissors_u.png")
...
#     Destory_hand()
#     cavas_hand.place(x=850, y=0)
#     im_paper = tkinter.PhotoImage(file="Paper_u.png")
...
#     im_rock = tkinter.PhotoImage(file="Rock_c.png")
...
#     Destory_com()
#     cavas_com.place(x=450, y=0)
#     im_rock = tkinter.PhotoImage(file="Paper_c.png")
...
#     label_count_com["text"] = (str(count_com) + "번째 승리")
...
# button_start.pack()
# button_opthion = tkinter.Button(tk, text="옵션", font=("System", 25), command=option)  # 옵션 버튼
# button_opthion.pack()
